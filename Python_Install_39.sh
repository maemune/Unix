#!/bin/bash
#wget https://raw.githubusercontent.com/maemune/Unix/main/Python_Install_39.sh && nano ./Python_Install_39.sh && chmod u+x ./Python_Install_39.sh && ./Python_Install_39.sh
